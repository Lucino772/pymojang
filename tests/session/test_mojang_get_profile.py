...
class TestMojangGetProfile(unittest.TestCase):
    ...
    def test200(self):
        ...
        assert profile.uuid == "4ba22ce11f064d7f9f715634aa0d7973"
        assert profile.name == "Lucino772"
        assert profile.skins == [
            Skin(
                "http://textures.minecraft.net/texture/1a4af718455d4aab528e7a61f86fa25e6a369d1768dcb13f7df319a713eb810b",
                "CLASSIC",
    ...
    def test401(self):
        ...
        pytest.raises(Unauthorized, session.get_profile, "TOKEN")
